...
export function TypeManager({ open, onClose, endpoint, usageTable, types, reload }: { open: boolean; onClose: () => void; endpoint: "income-types"|"expense-types"; usageTable: "incomes"|"expenses"; types: TypeRow[]; reload: () => void }) {
